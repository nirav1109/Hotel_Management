...
while($row=$res->fetch_object())
	  {
	  	?>
<tr><td><?php echo "101"/*echo $cnt;;*/?></td>
<td><?php echo"Samras" /*$row->seater;*/?></td>
<td><?php echo "50"/*$row->room_no;*/?></td>
<td><?php echo "30"/*$row->fees;*/?></td>
<td><?php echo "25"/*$row->posting_date;*/?></td>
<td><?php echo "20"/*$row->posting_date;*/?></td>
