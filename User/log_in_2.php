...
<!--/main-header-->
  <div class="w3layouts-top-strip">
			<div class="top-srip-agileinfo">
				...
				<div class="agileits-contact-info text-right">
					<ul>
						<li><i class="fa fa-volume-control-phone" aria-hidden="true"></i>+91 9714181381</li>
						<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:karathiyanirav@gmail.com">karathiyanirav@gmail.com</a></li>
					</ul>
				</div>
			   ...
			   <div class="header-w3-agileits" id="home">
			     <div class="inner-header-agile">	
				           ...
				           <ul class="nav navbar-nav">
											    <li><a href="#">Home</a></li>
												<li class="active"><a href="3">About</a></li>
												<li><a href="#">Gallery</a></li>
												 <li class="dropdown">
													<a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-hover="Pages" data-toggle="dropdown" aria-expanded="false">Pages <b class="caret"></b></a>
 ...
 <!--//main-header-->
    <!-- breadcrumb -->
   		<div class="book-form" style="display:none">

			   <form action="#" method="post">
			   	<h3 class="tittle why">Log In</h3>
			   	<br>
					<div class="col-md-6 form-date-w3-agileits">

						<label><i class="fa fa-user" aria-hidden="true"></i>  Enter Username :</label>
						<input type="text" name="name" placeholder="Your Username" required="">
					</div>
					<div class="col-md-6 form-date-w3-agileits">
						<label><i class="fa fa-user" aria-hidden="true"></i>  Enter Password :</label>
						<input type="password" name="Password" placeholder="Your Password" required="">
						<br>
						<br>
						 	<a href="#"><h4 class="tittle why">Forgot Password</h4>
						<br>
					</div>
