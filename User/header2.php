...
<title>Resort a Hotel Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- for-mobile-apps -->
...
<script>
	...
	function signupvaliation()
	{
		...
		if(email1.value=="")
			...
			{
				document.getElementById('recap').innerHTML="Please Click On Image";
				return false;
			     ...
			     <div class="inner-header-agile">	
								<nav class="navbar navbar-default">
									<div class="navbar-header">
										...
										<h1><a  href="index1.php"><span>D</span>ream<p class="s-log">Hotel</p></a>
	...
	<div class="se-pre-con"></div>
				 ...
				 <ul class="nav navbar-nav">
											<li class="active"><a href="index1.php">Home</a></li>
												<li><a href="check_avail.php">Book Room</a></li>
												...
												<li style="border-right:none"><a href="#" onclick="document.getElementById('id01').style.display='block';document.getElementById('logint').classList.add('active1');" style="width:auto;">Login/Sign-Up</a></li>
													...
													<a href="codes.html" class="dropdown-toggle hvr-bounce-to-bottom" data-hover="Pages" data-toggle="dropdown" aria-expanded="false">My Account<b class="caret"></b></a>
													 <ul class="dropdown-menu" >
														...
														<li><a href="icons.html">My Reservation</a></li>
     ...
     <?php
  	...
  	if(isset($_POST['submit1']))
  	{
  		...
  		else
  		{
			...
			mysqli_select_db($connection,"hotel_managment") or die(mysqli_error($connection));
...
<?php 
			...
			mysqli_select_db($connection,"hotel_managment") or die(mysqli_error($connection));
				...
				$insert=mysqli_query($connection,$ins) or die(mysqli_error($conn));
				if(!$insert)
				{
					$cpass_temp	=$signcpass;
   					$email_temp	=$sign_email;
					...
					$_SESSION['sign_err']="error";
					echo"<script>document.getElementById('id01').style.display='block';</script>";
					mysqli_close($connection);
				}
				else
				{
					$_SESSION['login']=$sign_email;
					$secondsWait = 0;
				 	echo '<meta http-equiv="refresh" content="'.$secondsWait.'">';
					mysqli_close($connection);
				}
  ...
  <form name="form1" action="" id="form1" method="post" onsubmit="return signupvaliation()">
    ...
    <div class="g-recaptcha" data-sitekey="6Lc4LUcUAAAAAGsGK5nJ-xFryNzHHJaLEa_1bWxd" data-type="image"></div><span id="recap" style="color:red"></span><br>
<label>
   ...
   ?>
  		...
  		<div id="forgot" style="display:none">
  			...
  			?>
  			<?php if(isset($_SESSION['sign_err']))
  				{
  					?>
  					<script type="text/javascript">
